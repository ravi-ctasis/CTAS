  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50">
        {/* HERO SECTION */}
        <section className="relative overflow-hidden bg-gradient-to-br from-orange-900 via-red-800 to-yellow-700 py-12 lg:py-20">
          {/* Modern Geometric Background */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-20 left-10 w-32 h-32 border-2 border-orange-400/30 rounded-full animate-spin-slow"></div>
            <div className="absolute bottom-20 right-10 w-40 h-40 border-2 border-red-400/30 transform rotate-45 animate-pulse"></div>
            <div className="absolute top-1/2 left-1/3 w-24 h-24 border-2 border-yellow-400/30 transform -rotate-12 animate-bounce"></div>
            <div className="absolute top-1/3 right-1/4 w-16 h-16 border-2 border-orange-400/30 rounded-full animate-ping"></div>
            <div className="absolute top-1/4 left-1/2 w-20 h-20 border-2 border-red-400/30 transform rotate-30 animate-spin"></div>
          </div>

          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              {/* Badge */}
              <div className="inline-flex items-center px-6 py-3 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 text-white text-sm font-medium mb-8 shadow-2xl">
                <Utensils className="w-5 h-5 mr-3" />
                Culinary Innovation Platform
              </div>

              {/* Main Heading */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-8 leading-tight">
                Revolutionize
                <span className="block text-transparent bg-gradient-to-r from-orange-400 via-red-400 to-yellow-400 bg-clip-text">
                  Food & Beverage
                </span>
              </h1>

              {/* Description */}
              <p className="text-lg sm:text-xl lg:text-2xl text-orange-100 max-w-4xl mx-auto mb-10 leading-relaxed font-medium">
                Build innovative restaurant and delivery platforms that connect customers with
                amazing culinary experiences, streamline operations, and drive growth in the food
                industry.
              </p>

              {/* Floating Action Button */}
              <div className="absolute top-8 right-8">
                <button className="group relative p-4 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 hover:bg-white/30 transition-all duration-300 hover:scale-110">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-red-400 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
                {[
                  ...
                  { label: "Orders Processed", value: "1M+", icon: Package },
                  ...
                  return (
                    <div
                      key={index}
                      className="group text-center p-6 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-500 hover:scale-110 hover:rotate-2 relative overflow-hidden"
                    >
                      ...
                      <Icon className="w-10 h-10 text-orange-300 mx-auto mb-3 relative z-10 group-hover:scale-125 transition-transform duration-500" />
                      <div className="text-3xl lg:text-4xl font-black text-white mb-2 relative z-10">
                        {stat.value}
                      </div>
                      <div className="text-sm text-orange-200 font-medium relative z-10">
                        {stat.label}
                      </div>
                    </div>
                  );
        ...
        {/* CTA SECTION */}
        <section className="py-20 bg-gradient-to-r from-green-600 to-blue-700 overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-orange-900/50 via-red-800/50 to-yellow-700/50"></div>
            <div className="absolute top-20 right-20 w-64 h-64 bg-white/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-20 left-20 w-96 h-96 bg-white/5 rounded-full blur-3xl"></div>
            <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-gradient-to-br from-orange-400/20 to-red-400/20 rounded-full blur-2xl animate-pulse"></div>
          </div>

          <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Ready to Transform Food & Beverage?
            </h2>
            <p className="text-xl text-orange-100 mb-10 leading-relaxed">
              Join the culinary revolution with our comprehensive platform. Let&apos;s create food
              solutions that delight customers and drive growth.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact-us"
                className="inline-flex items-center px-8 py-4 bg-white text-orange-900 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:rotate-1"
              >
                Start Your Project
              ...
              <Link
                href="/portfolios"
                className="inline-flex items-center px-8 py-4 border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/10 transition-all duration-300 hover:scale-105"
              >
                Portfolio
                <ArrowRight className="ml-2 w-5 h-5" />
              </Link>
