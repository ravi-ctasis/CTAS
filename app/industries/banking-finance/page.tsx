      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        <section className="relative overflow-hidden  py-12 lg:py-20">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            ></div>
            <div
              className="absolute top-1/2 left-1/3 w-24 h-24 bg-teal-500/10 rounded-full blur-xl animate-pulse"
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-emerald-100 max-w-4xl mx-auto mb-10 leading-relaxed font-medium">
                Revolutionizing financial services with AI-powered solutions, blockchain
                integration, and cloud-native architecture for the digital banking era.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                <Link href="/contact-us">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-10 py-4 text-lg font-bold rounded-full transition-all duration-300 hover:shadow-2xl hover:scale-110 border-0 cursor-pointer"
                  >
                ...
                <Link href="/portfolios">
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-emerald-300 text-emerald-100 hover:bg-emerald-600 hover:text-white px-10 py-4 text-lg font-bold rounded-full transition-all duration-300 backdrop-blur-sm cursor-pointer"
                  >
                    View Portfolio
                  </Button>
                </Link>
        ...
        <section className="py-12 lg:py-20 bg-gradient-to-r from-green-600 to-blue-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-blue-100 max-w-3xl mx-auto mb-8">
              Let&apos;s discuss how our secure, compliant, and innovative solutions can drive your
              financial institution&apos;s digital transformation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/contact-us">
                <Button
                  size="lg"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-105 cursor-pointer"
                >
                  Start Free Consultation
              ...
              <Link href="/portfolios">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-blue-300 text-blue-100 hover:bg-blue-600 hover:text-white px-8 py-3 text-lg font-semibold rounded-lg transition-all duration-300 cursor-pointer"
                >
                  View Portfolio
                </Button>
              </Link>
