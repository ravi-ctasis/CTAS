  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        {/* HERO SECTION */}
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-700 py-12 lg:py-20">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-br from-indigo-400/20 to-blue-400/20 rounded-full blur-2xl"></div>
            <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-purple-400/20 to-indigo-400/20 rounded-full blur-xl"></div>
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              {/* Description */}
              <p className="text-lg sm:text-xl lg:text-2xl text-indigo-100 max-w-4xl mx-auto mb-10 leading-relaxed font-medium">
                Build innovative mobility and logistics applications that optimize routes, enhance
                fleet management, and create seamless transportation experiences for the modern
                world.
              </p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
                {[
                  ...
                  { label: "Routes Optimized", value: "10K+", icon: Route },
        ...
        <section className="py-20 bg-gradient-to-r from-green-600 to-blue-700 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-900/50 to-indigo-800/50"></div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
            ...
            <p className="text-xl text-blue-100 mb-10 leading-relaxed">
              Join the mobility revolution with our comprehensive platform. Let&apos;s create
              transportation solutions that move the world forward.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact-us"
                className="inline-flex items-center px-8 py-4 bg-white text-blue-900 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:rotate-1"
              >
                Start Your Project
