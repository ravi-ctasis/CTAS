  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
        {/* HERO SECTION */}
        <section className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-700 py-12 lg:py-20">
          {/* Abstract Background Pattern */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-pink-400/20 to-purple-400/20 rounded-full blur-3xl"></div>
            <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-indigo-400/20 to-blue-400/20 rounded-full blur-3xl"></div>
            <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-2xl"></div>
            <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-blue-400/20 to-indigo-400/20 rounded-full blur-xl"></div>
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-8 leading-tight">
                Revolutionize
                <span className="block text-transparent bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 bg-clip-text">
                  Digital Health
                </span>
              </h1>

              {/* Description */}
              <p className="text-lg sm:text-xl lg:text-2xl text-purple-100 max-w-4xl mx-auto mb-10 leading-relaxed font-medium">
                Create cutting-edge health applications that leverage AI, IoT, and cloud
                technologies to deliver personalized healthcare experiences that transform lives.
              </p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
                {[
                  ...
                  { label: "Health Metrics", value: "50+", icon: TrendingUp },
                  ...
                  return (
                    <div
                      key={index}
                      className="text-center p-6 rounded-3xl bg-white/15 backdrop-blur-sm border border-white/25 hover:bg-white/25 transition-all duration-300 hover:scale-105 hover:rotate-1"
                    >
                      <Icon className="w-10 h-10 text-pink-300 mx-auto mb-3" />
        ...
        {/* CTA SECTION */}
        <section className="py-20 bg-gradient-to-r from-green-600 to-blue-700 relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-indigo-900/50 to-purple-800/50"></div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
            ...
            <p className="text-xl text-indigo-100 mb-10 leading-relaxed">
              Join the digital health revolution with our comprehensive platform. Let&apos;s create
              an application that transforms lives and promotes better health.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact-us"
                className="inline-flex items-center px-8 py-4 bg-white text-indigo-900 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:rotate-1"
              >
                Start Your Project
