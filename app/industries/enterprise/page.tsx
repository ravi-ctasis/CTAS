  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-blue-900 py-12 lg:py-20">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto mb-10 leading-relaxed font-medium">
                Empowering enterprises with cutting-edge technology solutions, scalable
                architecture, and intelligent automation for the digital age.
              </p>
        ...
        <section className="py-12 lg:py-20 bg-gradient-to-r from-green-600 to-blue-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-blue-100 max-w-3xl mx-auto mb-8">
              Let&apos;s discuss how our comprehensive enterprise solutions can drive your
              organization&apos;s digital transformation and business growth.
            </p>
