...
const useCases: UseCase[] = [
  ...
  },
  {
    ...
    benefits: ["Data visualization", "Reporting tools", "Workflow automation", "Integration APIs"],
  },
];
...
export default function MERNStackPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="py-24 bg-gradient-to-br from-green-900 via-blue-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <Badge className="bg-green-500/20 text-green-200 border-green-400/30 mb-6">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed">
              Build modern, scalable web applications using MongoDB, Express.js, React.js, and
              Node.js. Full-stack JavaScript development for rapid deployment and optimal
              performance.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact-us">
                <Button className="bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white px-8 py-4 text-lg font-semibold rounded-xl">
                  Start Project
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">The MERN Technology Stack</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive features that make MERN stack the preferred choice for modern web
              development
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-green-100 to-blue-100 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              MERN stack excels in building various types of web applications
            </p>
          </div>
            ...
            {useCases.map((useCase) => (
              ...
              >
                <div className="flex items-start space-x-4 mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-100 to-blue-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                    {useCase.icon}
                  </div>
                  <div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose MERN Stack?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">JavaScript Everywhere</h3>
              <p className="text-gray-600">Single language for frontend and backend development</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Rapid prototyping and quick time-to-market</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Easy to scale as your business grows</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Extensive support and resources available</p>
            </div>
          </div>
        </div>
      </section>
