...
export const metadata: Metadata = {
  title: 'Custom API Development Services | Ctas Info Services',
  ...
  openGraph: {
    title: 'Custom API Development & Integration Services | Ctas Info Services',
    description: 'Secure, scalable custom API development and third-party integration services. We build robust microservices and REST/GraphQL architectures.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Custom API Development & Integration Services by Ctas Info Services',
      }
    ],
  },
  twitter: {
