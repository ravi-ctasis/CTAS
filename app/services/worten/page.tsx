...
export const metadata: Metadata = {
  title: 'Worten Marketplace Integration | Ctas Info Services',
  ...
  openGraph: {
    title: 'Worten Marketplace Integration | Iberian E-commerce | Ctas Info Services',
    description: 'Automate your sales on Worten Portugal & Spain. Mirakl-based API integration for catalog sync, live inventory management, and order routing.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Worten Integration Services by Ctas Info Services',
      }
    ],
  },
  twitter: {
