import { Store, Package, ShoppingCart, Zap, Users, Shield, ArrowRight, Award, Clock, BarChart3, Layers, FileText, Bot, Settings, Upload, TrendingUp } from "lucide-react";
...
const coreFeatures = [
  {
    ...
    description: "Manage stock levels and pricing from one unified dashboard. Every update reflects instantly across all connected sales channels",
    icon: Package,
  },
  {
    title: "Unified Order Management",
    description: "Receive and manage orders from every connected marketplace in a single inbox - no more switching tabs between platforms",
    icon: ShoppingCart,
  },
  {
    title: "Real-Time Inventory Sync",
    description: "Stock changes on one channel automatically sync across all others in real time, keeping quantities accurate everywhere",
    icon: Zap,
  },
];
...
const listingTools = [
  {
    ...
    description: "List your own white-label products across any connected marketplace with full control over branding and presentation",
    icon: Layers,
  },
  {
    title: "Variant Management",
    description: "Easily create and manage product variants (size, color, style, etc.) across listings, keeping catalog data consistent",
    icon: FileText,
  },
  {
    title: "AI-Generated Catalog Details",
    description: "Generate optimized product titles, descriptions, and catalog details automatically using AI - cutting listing time from hours to minutes",
    icon: Bot,
  },
  {
    title: "Smart Catalog Matching",
    description: "When a white-label listing matches an existing retail catalog entry, automatically suggests switching to the matched retail listing",
    icon: Settings,
  },
  {
    title: "Related Product Suggestions",
    description: "Surface relevant product matches and cross-listing opportunities to help sellers expand their catalog intelligently",
    icon: ArrowRight,
  },
];
...
const pricingTools = [
  {
    ...
    description: "Automatically adjust pricing based on competition, rules, and market conditions - all managed from the same place as inventory",
    icon: BarChart3,
  },
  {
    title: "Revenue & Performance Dashboard",
    description: "Centralized dashboard surfaces revenue trends, listing performance, and key KPIs across every channel",
    icon: BarChart3,
  },
];
...
const operations = [
  {
    ...
    description: "Enterprise-grade auth guards with configurable role creation let teams assign granular permissions",
    icon: Shield,
  },
  {
    title: "Bulk Operations via File Upload",
    description: "Perform bulk updates - inventory, pricing, listings - through simple file-based uploads, saving hours on large catalog management",
    icon: Upload,
  },
];

const marketplaces = [
  "Amazon", "Etsy", "eBay", "Walmart", "Shopify", "And More"
];
    ...
    <div className="min-h-screen bg-[#F6F8FA]">
      ...
      <main>
        <MetaTags
          ...
          keywords={["multi-channel selling", "inventory management", "Amazon Etsy integration", "order management", "SellerBuz", "catalog management"]}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl font-bold text-gray-900 mb-6">
                  Seller<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-orange-500">Buz</span>
                </h1>
                ...
                <div className="bg-gradient-to-br from-blue-500 to-orange-500 rounded-2xl p-1">
                  <div className="bg-white rounded-xl p-8">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-gray-900 mb-2">Unified Platform</div>
                      <div className="text-gray-600">Multi-Channel Selling</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white rounded-xl p-8 shadow-lg">
                ...
                <p className="text-gray-600">
                  A dedicated library for managing enhanced content assets (A+ Content) used in premium listings — keeping creative assets organized and reusable across products and channels.
                </p>
              </div>
            </div>
          </div>
