...
export const metadata: Metadata = {
  title: 'Sports Tracking & Analytics App | Ctas Info Services',
  ...
  openGraph: {
    title: 'Sports Tracking & Analytics App Development | Ctas Info Services',
    description: 'Custom sports tracking solutions. We build apps that monitor athletic performance, integrate with wearables, and provide deep biometrical analytics.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Sports Tracking & Analytics App Development by Ctas Info Services',
      }
    ],
  },
  twitter: {
