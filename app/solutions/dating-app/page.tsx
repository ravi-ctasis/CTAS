...
export const metadata: Metadata = {
  title: 'Dating App Development Solutions | Ctas Info Services',
  ...
  openGraph: {
    title: 'Dating App Development Solutions | Custom Matchmaking Apps | Ctas Info Services',
    description: 'Engaging, secure dating app development. We build scalable matchmaking platforms with real-time chat, geolocation, and advanced matching algorithms.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Dating App Development Solutions by Ctas Info Services',
      }
    ],
  },
  twitter: {
