...
export const metadata: Metadata = {
  title: 'Travel App Development | Ctas Info Services',
  ...
  openGraph: {
    title: 'Travel App Development | Journey Planning Solutions | Ctas Info Services',
    description: 'Transform tourism with custom travel apps. We build itinerary planners, flight booking engines, and immersive travel guides for modern explorers.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Travel App Development by Ctas Info Services',
      }
    ],
  },
  twitter: {
