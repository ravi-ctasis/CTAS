...
export const metadata: Metadata = {
  title: 'Mobile Wallet & FinTech App Development | Ctas Info Services',
  ...
  openGraph: {
    title: 'Mobile Wallet & FinTech App Development | Secure Payments | Ctas Info Services',
    description: 'Secure FinTech app solutions. We build robust mobile wallets, P2P payment applications, and crypto-integrated financial platforms.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mobile Wallet & FinTech App Development by Ctas Info Services',
      }
    ],
  },
  twitter: {
